...
public class SinhVien {
	...
	public SinhVien(int maSinhVien, String tenSinhVien, String queQuan, Date ngay, boolean gioiTinh, float diemMon1,
	...
	public String toString() {
		return "SinhVien [maSinhVien=" + maSinhVien + ", tenSinhVien=" + tenSinhVien + ", queQuan=" + queQuan
				+ ", ngay=" + ngay + ", gioiTinh=" + gioiTinh + ", diemMon1=" + diemMon1 + ", diemMon2=" + diemMon2
				+ ", diemMon3=" + diemMon3 + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(diemMon1, diemMon2, diemMon3, gioiTinh, maSinhVien, ngay, queQuan, tenSinhVien);
	}
	...
	public boolean equals(Object obj) {
		...
		return Float.floatToIntBits(diemMon1) == Float.floatToIntBits(other.diemMon1)
				...
				&& maSinhVien == other.maSinhVien && Objects.equals(ngay, other.ngay)
